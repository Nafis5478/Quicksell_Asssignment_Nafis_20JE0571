...
const Navbar = () => {
  ...
  return (
    <div className="navbar" style={{color:"white"}}>
      <div className="navbarButton" style={{color:"white"}}>
        ...
        {slider && (
          <>
            <div className="dropDown"style={{backgroundColor:"black",color:"white"}}>
              <div className="group" style={{backgroundColor:"black",color:"white"}}>
                <span style={{ backgroundColor: "black", color:"white" }}>Grouping</span>
                <select
                  value={groups}
              ...
              <div className="group" style={{backgroundColor:"black",color:"white"}}>
                <span style={{backgroundColor:"black",color:"white"}}>Ordering</span>
                <select
                  value={order}
